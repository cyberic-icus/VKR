;!function (e, t) {
    ...
    r.prompt = function (e, t) {
        ...
        return r.open(i.extend({
            ...
            yes: function (i) {
                var n = l.val();
                "" === n ? l.focus() : n.length > (e.maxlength || 500) ? r.tips("Максимальное количество символов: " + (e.maxlength || 500), l, {tips: 1}) : t && t(n, i, l)
            }
        }, e))
    }, r.tab = function (e) {
        e = e || {};
        ...
        if (t = t || {}, t.photos) {
            ...
            if (l.imgIndex = (0 | u) + 1, t.img = t.img || "img", s) {
                if (0 === d.length) return r.msg("Нет изображения")
            } else {
            ...
            l.imgprev = function (e) {
                ...
                r.close(l.loadi), r.msg("Текущий адрес изображения некорректен.<br>Продолжить просмотр следующего изображения?", {
                    time: 3e4,
                    btn: ["Следующее", "Не смотреть"],
                    yes: function () {
